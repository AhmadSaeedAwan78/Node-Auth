  ...
  async updatePage(req, res) {
    try {
      ...
      sendSuccess(res, 'Page updaetd.', page);
        ...
        sendError(res, errorMessages[errorTypes.RECORD_NOT_FOUND], {}, {}, errorTypes.RECORD_NOT_FOUND);
      }
  ...
  async createPage(req, res) {
    try {
      ...
      if (page) {
        ...
        sendError(res, 'Unable to create page, please try again', {}, {}, errorTypes.UNABLE_TO_STORE_DATA, 200);
      }
    } catch (err) {
      sendCatchedError(res, '', err, {});
    }
